...
function! s:BufSyntax()
  if (!exists("g:rails_syntax") || g:rails_syntax)
    ...
    if &syntax == 'ruby'
      if classes != ''
        exe "syn keyword rubyRailsUserClassDeclaration ".classes." containedIn=rubyClassDeclaration contained"
        exe "syn keyword rubyRailsUserClass ".classes." containedIn=rubyBlock,rubyCurlyBlock contained"
      endif
      if buffer.type_name() == ''
